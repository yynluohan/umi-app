  ...
  render () {
    ...
    const columnsObj = [
          ...
          <span>
            {
              index !== 0
                ? <Input
                  value={record.region !== undefined ? record.region : ''}
      ...
      },
      {
        ...
        render: (record, text, index) => (
          <InputNumber
            value={record.firstPiece !== undefined ? record.firstPiece : ''}
      ...
      },
      {
        ...
        render: (record, text, index) => (
          <InputNumber
            value={record.firstAmount !== undefined ? record.firstAmount : ''}
      ...
      },
      {
        ...
        render: (record, text, index) => (
          <InputNumber
            value={record.secondPiece !== undefined ? record.secondPiece : ''}
      ...
      },
      {
        ...
        render: (record, text, index) => (
          <InputNumber
            value={record.secondAmount !== undefined ? record.secondAmount : ''}
          ...
          <Row>
            ...
            <Col span={24}>
              <FormItem label='运送方式' hasFeedback {...formItemLayout(3, 20)}>
                <Checkbox
                  onChange={(e) => this.onChange(e, 'fast')}
                  checked={fastList.length > 0}
                >快递
                </Checkbox>
                {
                  fastList.length > 0
                ...
                <br />
                <Checkbox
                  onChange={(e) => this.onChange(e, 'ems')}
                  checked={emsList.length > 0}
                >EMS
                </Checkbox>
                {
                  emsList.length > 0
