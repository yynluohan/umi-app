...
class InventoryCheck extends React.Component {
  constructor (props) {
    super(props)
    ...
    return (
      <div style={{ backgroundColor: '#fff', padding: '20px' }}>
        ...
        <div style={{ textAlign: 'right', marginTop: '2em' }}>
          <Button type='primary' style={{ marginRight: '1em' }} onClick={() => this.onSubmit('')}>开始盘点</Button>
...
export default connect(mapStateToProps)(InventoryCheck)
