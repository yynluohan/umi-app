...
class Selection extends React.Component {
  ...
  showModal () {
    ...
    this.props.apiUrl && this.props.method(this.props.apiUrl, { ...this.props.queryData }).then(({ code, data, status_code }) => {
  ...
  render () {
    ...
    const {
      list, selectedRowKeys, type, modalTitle, total, pageSize, size, getDisabled,
      isShowButtonText, isHiddenRow
    } = this.state
